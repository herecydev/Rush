...
namespace Rush.Tests
{
	public class BroadcastSenderTests
	{
		...
		public class GivenMultipleChannelsAndAllAreOperational
		{
			...
			private readonly BroadcastSender<string> _messageSender;
			private readonly Mock<ILogger<BroadcastSender<string>>> _logger;
			...
			public GivenMultipleChannelsAndAllAreOperational()
			{
				...
				_logger = new Mock<ILogger<BroadcastSender<string>>>();

				_messageSender = new BroadcastSender<string>(new[] { _firstChannel.Object, _secondChannel.Object, _thirdChannel.Object }, _logger.Object);
			}
			...
			public class WhenSending : GivenMultipleChannelsAndAllAreOperational
			{
				...
				[Unit]
				public async Task ThenSendsToAllChannels()
				{
					var count = 0;
		...
		public class GivenMultipleChannelsAndSomeAreOperational
		{
			...
			public GivenMultipleChannelsAndSomeAreOperational()
			{
				...
				_messageSender = new BroadcastSender<string>(new[] { _inoperativeChannel.Object, _operationalChannel.Object }, _logger.Object);
			}
